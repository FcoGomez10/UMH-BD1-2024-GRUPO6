...
insert into tbl_TipoPersona (id_TipoPersona, Rol)
values (1, "Tradente"),
(2, "Adquiriente"),
(3, "Rep_legal_Tradente"),
(4, "Rep_legal_Adquiriente"),
(5, "Gestor");
...
SELECT 
    p.id_Persona, p.Nombre, p.DNI, p.No_Telefono, d.Departamento, d.Municipio,
    tp.Rol
FROM 
    tbl_proceso sp
JOIN 
